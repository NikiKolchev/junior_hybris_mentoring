 ...
 */
package de.hybris.telcotrail.storefront.interceptors;
...
import de.hybris.telcotrail.storefront.util.CSRFHandlerInterceptor;
import de.hybris.telcotrail.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "de.hybris.telcotrail.storefront.util.CSRFTokenManager.tokenval";
