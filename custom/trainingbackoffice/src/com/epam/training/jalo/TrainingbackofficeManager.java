...
import com.epam.training.constants.TrainingbackofficeConstants;
...
public class TrainingbackofficeManager extends GeneratedTrainingbackofficeManager
{
	...
	private static final Logger LOG = Logger.getLogger(TrainingbackofficeManager.class.getName());
	 ...
	 */
	public static TrainingbackofficeManager getInstance()
	{
		return (TrainingbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingbackofficeManager called.");
		}
	}
