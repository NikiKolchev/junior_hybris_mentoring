...
import com.epam.training.constants.TrainingwebservicesConstants;



/**
 * This is the extension manager of the Trainingwebservices extension.
 */
public class TrainingwebservicesManager extends GeneratedTrainingwebservicesManager
{
	 ...
	 */
	public static TrainingwebservicesManager getInstance()
	{
		return (TrainingwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingwebservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingwebservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingwebservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingwebservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
