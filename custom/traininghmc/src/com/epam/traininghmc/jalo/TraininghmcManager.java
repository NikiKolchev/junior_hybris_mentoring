...
/**
 * This is the extension manager of the Traininghmc extension.
 */
public class TraininghmcManager extends GeneratedTraininghmcManager
{
	...
	{
		return (TraininghmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TraininghmcConstants.EXTENSIONNAME);
	}
