...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			de.hybris.telcotrail.core.jalo.ProductReferencesAndClassificationsComponent.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ProductReferencesAndClassificationsComponent",
			de.hybris.telcotrail.core.jalo.ProductReferencesAndClassificationsForDevicesComponent.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"Device",
			"Product",
			de.hybris.telcotrail.core.jalo.Device.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"Accessory",
			"Product",
			de.hybris.telcotrail.core.jalo.Accessory.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"ServicePlan",
			"SubscriptionProduct",
			de.hybris.telcotrail.core.jalo.ServicePlan.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"ServiceAddOn",
			"SubscriptionProduct",
			de.hybris.telcotrail.core.jalo.ServiceAddOn.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"TypeConstraint",
			de.hybris.telcotrail.core.jalo.ClassificationNotBlankConstraint.class,
			null,
			false,
			null,
			false
