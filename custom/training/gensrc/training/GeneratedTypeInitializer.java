...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"de.hybris.platform.persistence.training_Organization",
			false,
			null,
			false
		);
		...
		createRelationType(
			"Customer2Organization",
			"de.hybris.platform.persistence.link.training_Customer2Organization",
			false
		);
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		single_setRelAttributeProperties_Customer2Organization_source();
	
		single_setRelAttributeProperties_Customer2Organization_target();
			...
			single_setAttributeProperties_Organization_email();
						...
						public void single_setAttributeProperties_Organization_email() throws JaloBusinessException
						{
							...
							setAttributeProperties(
								...
								public void single_setRelAttributeProperties_Customer2Organization_source() throws JaloBusinessException
								{
								...
								public void single_setRelAttributeProperties_Customer2Organization_target() throws JaloBusinessException
								{
