...
/**
 * This is the extension manager of the Training extension.
 */
public class TrainingManager extends GeneratedTrainingManager {
    ...
    public static TrainingManager getInstance() {
        return (TrainingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
                TrainingConstants.EXTENSIONNAME);
    }
    ...
    public void createEssentialData(final Map<String, String> params, final JspContext jspc) {
        ...
        CatalogVersion src = cm.getCatalog("default").getCatalogVersion("staged");
        CatalogVersion tgt = cm.getCatalog("default").getCatalogVersion("online");
        ...
        AttributeDescriptor ad = TypeManager.getInstance().getComposedType(
                Organization.class
        ).getDeclaredAttributeDescriptor("customers");
